...
nmon_power_rhel73LE: $(FILE)
	gcc -o nmon_power_rhel73LE $(FILE) $(CFLAGS) $(LDFLAGS) -D POWER -D KERNEL_2_6_18 -D RHEL7
...
nmon_x86_fedora25: 
	cc -s -o nmon_x86_fedora25 $(FILE) $(CFLAGS) $(LDFLAGS) -D KERNEL_2_6_18  -D X86 -D RHEL7
